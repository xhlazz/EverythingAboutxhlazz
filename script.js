...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (daysUntilBirthday === 0) {
        ...
        birthdayInfoElement.textContent = `Oh, and hey my birthday since its in december 8. At least say "Happy Birthday" Since nobody might say that anyways..  ${daysUntilBirthday} days.`;
    }
});
